    ...
    public class FootIK : MonoBehaviour
{
        ...
        [SerializeField, Range(-100, 100), Tooltip("This parameter defines how much the characters spine should bend forward when running up on slopes.")]
        protected float m_slopeBendingUpwardsStrength = 7.5f;
        [SerializeField, Range(-100, 100), Tooltip("This parameter defines how much the characters spine should bend backward when running down on slopes.")]
        ...
        [SerializeField, Range(0, 20), Tooltip("This parameter defines how much the characters body should lean towards the moving direction when moving. This affects the whole body from the bottom of the feet to the top of the head and is always applied when the character moves.")]
        ...
        protected virtual void updateSlopeLeaning(GroundedResult groundedResult)
        {
            ...
            avgSlopeLeaning /= m_averageSlopeLeaningValuesQueue.Count;
        ...
        protected virtual Vector3 calculatePlanarVelocity(Vector3 feetZeroPos)
        {
            ...
            Vector3 velocity = (feetZeroPos - (m_prevTransformPosition + m_characterExternalMovingPlatformOffsetVec)) / Time.deltaTime;
        ...
        protected virtual void updateEvents(IKResult resultLeft, Vector3 ikLeftTargetPos, IKResult resultRight, Vector3 ikRightTargetPos, Vector3 transformMovementPlanarVec)
        {
            ...
            bool isStanding = transformMovementPlanarVec.magnitude / Time.deltaTime < 0.01f;
        ...
        protected virtual GroundedResult isValidAndGrounded(Vector3 feetZeroPos, Vector3 upVec, int collisionLayer)
        {
            ...
            if (m_autoUngroundUpwardsVelocity > 0)
            {
                ...
                if (dot > 0.975f)
                {
                    m_upwardsVelocity = distVec.magnitude / Time.deltaTime;
